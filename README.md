...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastapi-feedstock/blob/master/LICENSE.txt)

Summary: FastAPI framework, high performance, easy to learn, fast to code, ready for production

Development: https://github.com/tiangolo/fastapi
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7444&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastapi` can be installed with:

```
conda install fastapi
```

It is possible to list all of the versions of `fastapi` available on your platform with:
